...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset(ASSET.'assets/css/demo1/pages/general/login/login-4.css')}}" rel="stylesheet" type="text/css" />
        <!--{{asset(ASSET.'')}}-->
        <link href="{{asset(ASSET.'assets/css/demo1/style.bundle.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset(ASSET.'assets/css/demo1/skins/header/base/light.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset(ASSET.'assets/css/demo1/skins/header/menu/light.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset(ASSET.'assets/css/demo1/skins/brand/dark.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset(ASSET.'assets/css/demo1/skins/aside/dark.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
        ...
        <div class="kt-grid kt-grid--ver kt-grid--root">
            <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v4 kt-login--signin" id="kt_login">
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url({{asset(ASSET.'assets/media/bg/bg-2.jpg')}});">
                    <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                        <div class="kt-login__container">
                            <div class="kt-login__logo">
                                <a href="#">
                                    <img src="{{asset(ASSET.'assets/media/logos/logo-5.png')}}">
                                </a>
                            </div>
                                @yield('content')
                        </div>
        ...
        <script src="{{asset(ASSET.'assets/js/demo1/scripts.bundle.js')}}" type="text/javascript"></script>

        <!--end::Global Theme Bundle -->

        <!--begin::Page Scripts(used by this page) -->
        <script src="{{asset(ASSET.'assets/js/demo1/pages/login/login-general.js')}}" type="text/javascript"></script>
